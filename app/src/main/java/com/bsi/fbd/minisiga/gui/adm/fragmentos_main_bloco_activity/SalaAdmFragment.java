...
public class SalaAdmFragment extends Fragment {
    private ArrayList<Sala> resultado = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_sala_adm, container, false);
        recyclerView = view.findViewById(R.id.salaRecyclerAdm);
        recyclerView.setLayoutManager(new LinearLayoutManager(context));
        resultado.clear();
        com.bsi.fbd.minisiga.modelo.Response response = new Response("getsalas.php", context, recyclerView);
