...
public class ProfessorRegisterAdm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_professor_register_adm);
        ActionBar actionBar = getSupportActionBar();
        actionBar.hide();

        cpfLayout = findViewById(R.id.cpfLayoutRegisterProf);
        nomeLayout = findViewById(R.id.nomeLayoutRegisterProf);
        enderecoLayout = findViewById(R.id.enderecoLayoutRegisterProf);
        emailLayout = findViewById(R.id.emailLayoutRegisterProf);
        senhaLayout = findViewById(R.id.senhaLayoutRegisterProf);
    ...
    public void salvar(View view) {
        ...
        if (valido){
            if (Connection.getUrl() != null){
                ...
                String url = Connection.getUrl()+"registerprofessor.php"; // Completa com o ip já salvo
